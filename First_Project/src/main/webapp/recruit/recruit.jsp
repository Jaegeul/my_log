...
<meta charset="UTF-8">
<title>용병모집</title>
<link rel="stylesheet" type="text/css" href="/First_Project/css/recruit.css" />
</head>
<body>
	...
	<article>
		...
		<div id="recruitList">
			...
			<div id="board_insert" class="board_insert"
				onclick="location='/First_Project/recruit_write.jsp'">
				글등록
			</div>
		</div>
	...
	<script type="text/javascript" src="/First_Project/js/cal.js"></script>
</body>
</html>