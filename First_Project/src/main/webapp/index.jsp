...
<script type="text/javascript">
	$(function() {
		$('#row1_1').children('button').click(function(){
			$(this).attr('class', 'blue');
			$(this).siblings('button').attr('class', 'normal');
		});
		$('#row1_2').children('button').click(function(){
			$(this).attr('class', 'blue');
			$(this).siblings('button').attr('class', 'normal');
		});
		$('#row1_3').children('button').click(function(){
			$(this).attr('class', 'blue');
			$(this).siblings('button').attr('class', 'normal');
		});
		$('#row2_1').children('button').click(function(){
			$(this).attr('class', 'blue');
			$(this).siblings('button').attr('class', 'normal');
		});
		$('#row3_1').children('button').click(function(){
			$(this).attr('class', 'blue');
			$(this).siblings('button').attr('class', 'normal');
		});
	});
...
<body>
		...
		<header>
			<div id="top">
				...
				<div id="mainTap">
					...
					<div id="menu">
						<img id="three-dots" src="/First_Project/images/three-dots.svg"
			...
			<div id="nav">
				<span id = "selected">
					<a href="/First_Project/index.jsp">소셜매치&nbsp;&nbsp;<img
					src="/First_Project/images/social.svg"></a>
				</span>
				
				<span id = "nav_b">
					<a href="/First_Project/rental/rental.jsp">구장예약&nbsp;&nbsp;<img
					src="/First_Project/images/reservation.svg"></a> 
				</span>
				
				<span id = "nav_c">
					<a href="/First_Project/recruit/recruit.jsp">용병모집&nbsp;&nbsp;<img
    ...
    <a href="#"><img src="/First_Project/images/guide.png" /></a>
    <a href="#"><i class="fa-solid fa-angle-right"></i></a>
					...
					<div id="guide_img">
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img src="/First_Project/images/guide.png" alt="...">
							</div>
							<div class="carousel-item">
								<img src="/First_Project/images/fair.png" alt="...">
							</div>
							<div class="carousel-item">
								<img src="/First_Project/images/nocheating.png" alt="...">
							</div>
						</div>
					</div>
			...
			<div class="header_wrap">
				<div>
					<button id="detail" data-bs-toggle="collapse" href="#collapseExample"
						aria-expanded="false" aria-controls="collapseExample">매치
						상세설정</button>
				</div>
					<div><h5 style="font-size: 14px; font-weight: bolder;">총 12매치</h5></div>
			</div>
				...
				<div id="match_filter">
					<div id="m_t">
						<div id="row1">
							<div id="row1_1">
								<b>레벨</b><br>
								<button id="all" value="all" class="blue">전체</button>
								<button id="beginner" value="beginner" class="normal">초보</button>
								<button id="middle" value="middle" class="normal">중급</button>
								<button id="high" value="high" class="normal">고급</button>
							</div>
							<div id="row1_2">
								<b>매치 형태</b><br>
								<button name="match" value="all" class="blue">전체</button>
								<button name="match" value="2vs" class="normal">2파전</button>
								<button name="match" value="3vs" class="normal">3파전</button>
							</div>
							<div id="row1_3">
								<b>매치 인원</b><br>
								<button name="personnel" value="all" class="blue">전체</button>
								<button name="personnel" value="6v6" class="normal">6 vs
									6</button>
								<button name="personnel" value="7v7" class="normal">7 vs
									7</button>
							</div>
						</div>
						...
						<div id="row3">
							<div id="row3_1">
								<b>시간대</b><br>
								<button name="local" value="all" class="blue">전체</button>
								<button name="local" value="hour_06" class="normal">06:00</button>
								<button name="local" value="hour_07" class="normal">07:00</button>
								<button name="local" value="hour_08" class="normal">08:00</button>
								<button name="local" value="hour_09" class="normal">09:00</button>
								<button name="local" value="hour_10" class="normal">10:00</button>
								<button name="local" value="hour_11" class="normal">11:00</button>
								<button name="local" value="hour_12" class="normal">12:00</button>
								<button name="local" value="hour_13" class="normal">13:00</button>
								<button name="local" value="hour_14" class="normal">14:00</button>
								<button name="local" value="hour_15" class="normal">15:00</button>
								<button name="local" value="hour_16" class="normal">16:00</button>
								<button name="local" value="hour_17" class="normal">17:00</button>
								<button name="local" value="hour_18" class="normal">18:00</button>
								<button name="local" value="hour_19" class="normal">19:00</button>
								<button name="local" value="hour_20" class="normal">20:00</button>
								<button name="local" value="hour_21" class="normal">21:00</button>
								<button name="local" value="hour_22" class="normal">22:00</button>
								<button name="local" value="hour_23" class="normal">23:00</button>
								<button name="local" value="hour_00" class="normal">00:00</button>
							</div>
						</div>
					</div>
				</div>
			...
			<div id="list">
				<ul>
					<li class="item">
						<a href="/First_Project/social.jsp" style="outline: none; color: #222836; text-decoration: none; cursor: pointer;">
							<div class="time">
								<p>09:00</p>
							</div>
							<div class="info">
		...
		<footer>
			<div class="up">
				<img src="/First_Project/images/arrow-up-circle.svg" width="40" height="40">
			</div>
			<div id="f_logo">
				<a href="/First_Project/index.jsp"><img src="/First_Project/images/Logo.png" width="80"
			...
			<div id="social">
				...
				<img src="/First_Project/images/kakaotalk.png" width="33" height="33"
					alt="kakaotalk" /></a> <a href="https://www.instagram.com/" /><img
					src="/First_Project/images/instargram.png" width="33" height="34"
					alt="instargram" /> </a> <a href="https://www.youtube.com/"><img
					src="/First_Project/images/youtube.png" width="33" height="33" alt="youtube" />
				</a> <a href="https://www.facebook.com/" /><img
					src="/First_Project/images/facebook.png" width="33" height="33" alt="facebook" />
				</a>
			</div>
		</footer>
	</div>
